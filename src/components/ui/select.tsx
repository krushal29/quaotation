...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        // Core layout
        "relative z-[200] min-w-[8rem] overflow-hidden",
        // Solid opaque background — this is the key fix
        "bg-white dark:bg-slate-900",
        // Border & shape
        "rounded-xl border border-border/80",
        // Elevation — strong shadow so it clearly floats above content
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "rounded-lg py-2.5 pl-9 pr-3",
      // Typography
      "text-sm font-medium text-foreground",
      // Hover / focus states — solid background, no transparency
